document.getElementById('stickerButton').addEventListener('click', function() {
    ...
    function makeStickerResizable(stickerElement) {
        ...
        startX = e.clientX;
        startY = e.clientY;
        startWidth = parseInt(document.defaultView.getComputedStyle(stickerElement).width, 10);
        startHeight = parseInt(document.defaultView.getComputedStyle(stickerElement).height, 10);
      ...
      stickerElement.style.width = '15px';
      stickerElement.style.height = '7px';
      stickerElement.style.position = 'absolute';
      stickerElement.style.overflow = 'visible';
      stickerElement.style.transform = 'scale(0.2)';
